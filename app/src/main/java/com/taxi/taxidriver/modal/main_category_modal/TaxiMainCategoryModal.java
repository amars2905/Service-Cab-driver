package com.taxi.taxidriver.modal.main_category_modal;
...
public class TaxiMainCategoryModal implements Parcelable {
    ...
    public final static Creator<TaxiMainCategoryModal> CREATOR = new Creator<TaxiMainCategoryModal>() {
    ...
    protected TaxiMainCategoryModal(Parcel in) {
        ...
        in.readList(this.vehicle, (Vehicle.class.getClassLoader()));
    }
